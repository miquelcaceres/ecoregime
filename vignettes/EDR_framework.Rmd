...
traj <- ecotraj::defineTrajectories(state_dissim, 
                                    sites = rep(ID_sampling, each = 3),
                                    surveys = rep(ID_obs, 10))
traj_dissim <- ecotraj::trajectoryDistances(traj, distance.type = "DSPD")
...
traj_allEDR <- ecotraj::defineTrajectories(state_dissim_allEDR, 
                                           sites = abundance_allEDR$sampling_unit,
                                           surveys = abundance_allEDR$time)
traj_dissim_allEDR <- ecotraj::trajectoryDistances(traj_allEDR)
